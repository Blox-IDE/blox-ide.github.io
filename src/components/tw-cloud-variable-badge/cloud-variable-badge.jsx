    ...
    <div className={styles.badge}>
        ...
        <div className={styles.text}>
            <FormattedMessage
                ...
                defaultMessage="This project uses cloud variables. Blox IDE uses its own cloud variable server independent of Scratch. Beware of impersonation as anyone can change their username to anything. {learnMore}"
